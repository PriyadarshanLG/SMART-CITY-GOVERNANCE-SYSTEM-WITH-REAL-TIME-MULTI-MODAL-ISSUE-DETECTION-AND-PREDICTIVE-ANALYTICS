...
interface GovernmentRegisterModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function GovernmentRegisterModal({
  isOpen,
  onClose,
  onSwitchToLogin,
}: GovernmentRegisterModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-200">
      ...
      {/* Modal Card styled to match Reference Image 4 */}
      <div className="relative my-6 w-full max-w-lg overflow-hidden rounded-2xl border-2 border-[#1f7a7a]/40 bg-[#d8eabf] p-6 sm:p-8 shadow-2xl text-slate-900 animate-in zoom-in-95 duration-200 max-h-[92vh] overflow-y-auto">
        ...
        <div className="flex flex-col items-center text-center mb-5">
          ...
          <h2 className="text-lg font-black text-[#1a5b5b] tracking-tight">
            Smart City Citizen Registration Application
          </h2>
          <p className="text-[11px] font-hindi font-semibold text-slate-600">
            स्मार्ट सिटी मिशन · नागरिक खाता पंजीकरण
          </p>
        </div>

        {/* Registration Form (Reference Image 4) */}
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          {/* Register Account Button (Teal/Emerald) */}
          <button
            type="submit"
            disabled={isLoading}
          ...
          <div className="text-center pt-2">
            <button
              ...
              className="text-xs font-bold text-[#1a6464] hover:underline"
            >
              Back To Login
            </button>
          </div>
